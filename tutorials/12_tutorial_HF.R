...
# Load data
df <- read.csv("/Users/isabellameier/Desktop/StatsI_Fall2023/datasets/ess_euroscepticism.csv", row.names="X")
View(df)
...
# my notes - the imwbcnt coefficients means that that the higher the positive 
# attitude towards immigration the lower the euroskepticism
...
# Plot 
par(mar=c(5,4,3,3)) # Reset figure margins- my notes: because sometimes the 
# plot won't fit properly so you rreset the margins
...
# Subsetting data frames, df[row,column] - my notes - to see the specific 
# cases and undertsand why they are outliers
...
# my note - there is a huge difference betwen the predicted outcome 6.02  
# and the euroskepticism 1
...
# QQ (Quantile-quantile) plot - my notes - to see if our residuals come from
# a normal distribution. If your residuals have a diagonal shape then it
# means that your residuals have a normal distribution
# if you data doesn't have a normal distribution, you need more data
...
# my notes -if it didn't have homoscedasticity you can do....
...
# my notes -if you include the same variable twice you will have perfect colinearity
# and the coefficients for that variable will be NAs
